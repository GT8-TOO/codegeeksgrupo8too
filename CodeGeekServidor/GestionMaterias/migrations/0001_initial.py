    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciclo_par', models.BooleanField(default=False)),
            ],
            options={
                'db_table': 'ciclo',
                'managed': True,
        ...
        migrations.CreateModel(
            name='Imparte',
            fields=[
                ('numero_de_ciclo', models.PositiveIntegerField(primary_key=True, serialize=False, validators=[django.core.validators.MaxValueValidator(10)])),
            ],
            options={
                'db_table': 'imparte',
                'managed': True,
