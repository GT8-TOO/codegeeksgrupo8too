...
SECRET_KEY = 'django-insecure-=ss0!+)-ogy8*7@9si4p@8kw_s6u842uvjt@x3jc-pf0x=xljs'
...
LOCAL_APPS =[
    'apps.GestionMaterias',
    'apps.GestionLocales',
    'apps.GestionUsuarios',
    'apps.GestionReservas',
    'apps.VistasGenerales',
]
...
ROOT_URLCONF = 'CodeGeekServidor.urls'
