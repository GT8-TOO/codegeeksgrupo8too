  ...
  return (
    <div>
      ...
      <div style={{marginTop:'30px'}}>
        <Slide direction="left" in={slideChange===0} mountOnEnter unmountOnExit><div><RegistrarPensum url={props.url}/></div></Slide>
        <Slide direction="left" in={slideChange===1} mountOnEnter unmountOnExit><div><RegistrarCiclo url={props.url}/></div></Slide>
        <Slide direction="left" in={slideChange===2} mountOnEnter unmountOnExit><div><RegistrarMateria url={props.url}/></div></Slide>
      </div>
      <div style={{display:'flex', gap:'20px', marginTop:'40px'}}>
        {slideChange !==0 && <Button variant="contained" onClick={previousSlide}>Anterior</Button>}
        {slideChange !==2 && <Button variant="contained" onClick={nextSlide}>Siguiente</Button>}
